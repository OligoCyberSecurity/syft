...
func Convert(app clio.Application) *cobra.Command {
	...
	return app.SetupCommand(&cobra.Command{
		...
		Long:  "[Experimental] Convert SBOM files to, and from, SPDX, CycloneDX and Syft's format. For more info about data loss between formats see https://github.com/oligocybersecurity/syft#format-conversion-experimental",

...
<p align="center">
 &nbsp;<a href="https://github.com/oligocybersecurity/syft/actions/workflows/validations.yaml" target="_blank"><img alt="Validations" src="https://github.com/oligocybersecurity/syft/actions/workflows/validations.yaml/badge.svg"></a>&nbsp;
 &nbsp;<a href="https://goreportcard.com/report/github.com/oligocybersecurity/syft" target="_blank"><img alt="Go Report Card" src="https://goreportcard.com/badge/github.com/oligocybersecurity/syft"></a>&nbsp;
 &nbsp;<a href="https://github.com/oligocybersecurity/syft/releases/latest" target="_blank"><img alt="GitHub release" src="https://img.shields.io/github/release/anchore/syft.svg"></a>&nbsp;
 &nbsp;<a href="https://github.com/oligocybersecurity/syft" target="_blank"><img alt="GitHub go.mod Go version" src="https://img.shields.io/github/go-mod/go-version/anchore/syft.svg"></a>&nbsp;
...
Syft development is sponsored by [Anchore](https://anchore.com/), and is released under the [Apache-2.0 License](https://github.com/oligocybersecurity/syft?tab=Apache-2.0-1-ov-file). For commercial support options with Syft or Grype, please [contact Anchore](https://get.anchore.com/contact/).
...
Our [wiki](https://github.com/oligocybersecurity/syft/wiki) contains further details on the following topics:

* [Supported Sources](https://github.com/oligocybersecurity/syft/wiki/supported-sources)
* [File Selection](https://github.com/oligocybersecurity/syft/wiki/file-selection)
* [Excluding file paths](https://github.com/oligocybersecurity/syft/wiki/excluding-file-paths)
* [Output formats](https://github.com/oligocybersecurity/syft/wiki/output-formats)
* [Package Cataloger Selection](https://github.com/oligocybersecurity/syft/wiki/package-cataloger-selection) 
  * [Concepts](https://github.com/oligocybersecurity/syft/wiki/package-cataloger-selection#concepts)
  * [Examples](https://github.com/oligocybersecurity/syft/wiki/package-cataloger-selection#examples)
* [Using templates](https://github.com/oligocybersecurity/syft/wiki/using-templates)
* [Multiple outputs](https://github.com/oligocybersecurity/syft/wiki/multiple-outputs)
* [Private Registry Authentication](https://github.com/oligocybersecurity/syft/wiki/private-registry-authentication)
  * [Local Docker Credentials](https://github.com/oligocybersecurity/syft/wiki/private-registry-authentication#local-docker)
  * [Docker Credentials in Kubernetes](https://github.com/oligocybersecurity/syft/wiki/private-registry-authentication#docker-credentials-in-kubernetes)
* [Attestation (experimental)](https://github.com/oligocybersecurity/syft/wiki/attestation)
  * [Keyless Support](https://github.com/oligocybersecurity/syft/wiki/attestation#keyless-support)
  * [Local private key support](https://github.com/oligocybersecurity/syft/wiki/attestation#local-private-key-support)
  * [Adding an SBOM to an image as an attestation using Syft](https://github.com/oligocybersecurity/syft/wiki/attestation#adding-an-sbom-to-an-image-as-an-attestation-using-syft)
* [Configuration](https://github.com/oligocybersecurity/syft/wiki/configuration)

...
func TestPackagesCmdFlags(t *testing.T) {
	...
	tests := []struct {
		...
		// For the same commit:
		//   pass: https://github.com/oligocybersecurity/syft/runs/4611344142?check_suite_focus=true
		//   fail: https://github.com/oligocybersecurity/syft/runs/4611343586?check_suite_focus=true

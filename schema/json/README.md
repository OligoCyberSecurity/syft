...
- the `Document` struct definition within `github.com/oligocybersecurity/syft/syft/formats/syftjson/model/document.go` that governs the overall document shape
